...
<asp:Content ContentPlaceHolderId="PlaceHolderBodyRightMargin" runat="server">
	<div height="100%" class="ms-pagemargin"><img src="/_layouts/15/images/blank.gif?rev=23" width="10" height="1" alt="" /></div>
</asp:Content>
	...
	<div style="width: 940px; padding-left: 10px; padding-right: 10px">
		<div style="width: 940px">
			<div id="_invisibleIfEmpty" name="_invisibleIfEmpty" style="float: left; width: 240px">
				<WebPartPages:WebPartZone runat="server" title="<%$Resources:cms,WebPartZoneTitle_TopLeft%>" id="TopLeft" orientation="Vertical" />
			</div>
			<div id="_invisibleIfEmpty" name="_invisibleIfEmpty" style="width: 690px; margin-left: 250px">
				<WebPartPages:WebPartZone runat="server" title="<%$Resources:cms,WebPartZoneTitle_TopRight%>" id="TopRight" />
			</div>
		</div>
		<div id="_invisibleIfEmpty" name="_invisibleIfEmpty" style="width: 940px">
			<WebPartPages:WebPartZone runat="server" title="<%$Resources:cms,WebPartZoneTitle_Body%>" id="Body" orientation="Vertical" />
		</div>

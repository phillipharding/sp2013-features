...
<asp:Content ContentPlaceHolderId="PlaceHolderLeftActions" runat="server">
		  ...
		  <table id="ImgPreviewTable" cellspacing="2" cellpadding="0" border="0" width="100%" style="display:none">
			...
			<tr><td class="ms-navline" width="128"><img src="/_layouts/15/images/blank.gif?rev=23" width='1' height='1' alt="" /></td></tr>
			<tr>
			  <td valign="center" align="center" style="padding-top:3px" onclick="ClickPreview(); return false;">
				  <a name="lnkPreviewImg" id="lnkPreviewImg" href="Javascript:"><img src="/_layouts/15/images/preview.jpg?rev=23" name="ImgPreviewThumbnail" id="ImgPreviewThumbnail" class="thumbnail" height="90" width="120" alt="<SharePoint:EncodedLiteral runat='server' text='<%$Resources:wss,piclib_picturePreview%>' EncodeMethod='HtmlEncode'/>"></a><br>

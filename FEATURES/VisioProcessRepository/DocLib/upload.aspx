...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
    <SharePoint:EncodedLiteral runat="server" text="<%$Resources:vsrv, PR_uploadPageTitle%>" EncodeMethod='HtmlEncode'/>
</asp:Content>

<asp:Content ContentPlaceHolderId="PlaceHolderPageTitleInTitleArea" runat="server">
    <SharePoint:EncodedLiteral runat="server" text="<%$Resources:vsrv, PR_uploadPageTitleInTitleArea%>" EncodeMethod='HtmlEncode'/>: <SharePoint:ListProperty Property="LinkTitle" runat="server"/>
</asp:Content>

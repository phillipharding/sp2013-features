...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
	<SharePoint:EncodedLiteral runat="server" text="<%$Resources:wss,blog_summarypage_title%>" EncodeMethod='HtmlEncode'/> -
...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
	...
	<SharePoint:AnalyticsEvent runat="server" QueryStringValueName="ID" EventUrlTemplate="$Resources:core,lists_Folder;/$Resources:core,blogpost_Folder;/Forms/DispForm.asxp?ID={0}" />
</asp:Content>

...
protected override void OnLoad(EventArgs e)
{
    ...
    {        
		uint lcid = 1;
		if (site.SupportedUICultures.FirstOrDefault() != null)
		{
			lcid = (uint)site.SupportedUICultures.FirstOrDefault().LCID;
		}

		EncodedLiteral2.Text = SPUtility.GetLocalizedString("$Resources:eduserver,IDS_HomePageTitle", null, (uint)1);
    }
    else
    {
		EncodedLiteral2.Text = site.Title;
    }
}
</script>

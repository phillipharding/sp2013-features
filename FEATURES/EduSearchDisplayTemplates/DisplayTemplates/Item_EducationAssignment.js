function DisplayTemplate_EduAssignmentItem(ctx)
{
    var p=[];
    var cachePreviousTemplateData = ctx['DisplayTemplateData'];
    ctx['DisplayTemplateData'] = new Object();
    DisplayTemplate_EduAssignmentItem.DisplayTemplateData = ctx['DisplayTemplateData'];

    ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fSearch\u002fItem_EducationAssignment.js';
    ctx['DisplayTemplateData']['TemplateType']='Item';
    ctx['DisplayTemplateData']['Title']='EduAssignmentItem';
    ...
    if(!$isNull(ctx.CurrentItem) && !$isNull(ctx.ClientControl))
    {
        ...
        var hoverUrl = "~sitecollection/_catalogs/masterpage/Display Templates/Search/Item_EducationAssignment_HoverPanel.js";
        var hover_id = id + "_hover";

        p.push('<div id="',
                $htmlEncode(id),
                '" name="Item" data-displaytemplate="EduAssignmentItem" class="ms-srch-item" onmouseover="EnsureScriptParams(\'SearchUI.js\', \'HP.Show\', \'',
                $scriptEncode(id),
                '\', \'',
        ...
        if(!Srch.U.e(ctx.CurrentItem.EduEntityId))
        {
            ...
            eduPath = ctx.ScriptApplicationManager.states.contextUrl + "/SitePages/Edu/View.aspx?sp_edu_lp_type=2&sp_edu_lp_id=" + ctx.CurrentItem.EduEntityId;
        }
        else
        {
...
function RegisterTemplate_EduAssignmentItem()
{
    if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
        Srch.U.registerRenderTemplateByName("EduAssignmentItem", DisplayTemplate_EduAssignmentItem);
    }

    if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") 
    {
        Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fSearch\u002fItem_EducationAssignment.js", DisplayTemplate_EduAssignmentItem);
    }
}

RegisterTemplate_EduAssignmentItem();

if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
    RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fSearch\u002fItem_EducationAssignment.js"), RegisterTemplate_EduAssignmentItem);
}

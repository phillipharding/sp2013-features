...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
  ...
  <table class="ms-core-tableNoSpace ms-webpartPage-root" width="100%">
                ...
                <tr>
                    <td id="_invisibleIfEmpty" name="_invisibleIfEmpty" colspan="2" valign="top" width="100%"> <WebPartPages:WebPartZone runat="server" Title="loc:Header" ID="Header" FrameType="TitleBarOnly"/> </td>
                </tr>

                <tr>
                    <td id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" height="100%" width="100%"> <WebPartPages:WebPartZone runat="server" Title="loc:Body" ID="Body" FrameType="TitleBarOnly"/> </td>

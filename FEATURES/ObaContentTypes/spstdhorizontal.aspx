...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
  ...
  <table class="ms-core-tableNoSpace ms-webpartPage-root" width="100%">
		...
		<tr>
			<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" width="100%"> <WebPartPages:WebPartZone runat="server" Title="loc:FullPage" ID="FullPage" FrameType="TitleBarOnly" Orientation="Horizontal"/> </td>
		</tr>       

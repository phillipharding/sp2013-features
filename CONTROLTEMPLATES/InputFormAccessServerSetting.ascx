...
<%@ Control Language="C#" Inherits="Microsoft.Office.Access.Server.MossHost.InputFormAccessServerSetting,Microsoft.Office.Access.Server,Version=15.0.0.0,Culture=neutral,PublicKeyToken=71e9bce111e9429c"    compilationMode="Always" %>
<%@ Import Namespace="Microsoft.Office.Access.Server" %>
<%@ Import Namespace="Microsoft.Office.Access.Server.MossHost" %>
